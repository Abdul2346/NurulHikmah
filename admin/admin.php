    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <a href="tambah-admin.php" class="text-green"><i class="fa fa-plus"></i> Tambah</a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $p['level'] ?></td>
                            <td>
                                <a href="edit-admin.php?id=<?= $p['id'] ?>" title="Edit Data" class="text-orange"><i
                                        class="fa fa-edit"></i></a>
                                <a href="hapus.php?idadmin=<?= $p['id'] ?>"
